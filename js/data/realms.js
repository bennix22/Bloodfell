...
const REALMS = [
  ...
  /* ==================== 1.0 EXPANSION — the deep realms (52-75) ============= */
  {
    id: "sunless_reach", name: "Sunless Reach", lvl: 52, tier: 6,
    desc: "Past the last room there was more. There is always more. None of it has ever seen the sun.",
    unlock: { type: "level", value: 52 },
    enemies: [
      { n: "Pale Skitterer", r: "swarm" },
      { n: "Sunless Ghoul", r: "grunt" },
      { n: "Lightless Adept", r: "caster" },
      { n: "Grave-Cold Stalker", r: "stalker" },
      { n: "Reach Devourer", r: "brute" },
      { n: "Sepulchral Warden", r: "warden" },
    ],
  },
  {
    id: "bleeding_wastes", name: "The Bleeding Wastes", lvl: 55, tier: 6,
    desc: "The ground here weeps red and never scabs. Something under it has not stopped dying.",
    unlock: { type: "boss", value: "r4b1" },
    enemies: [
      { n: "Clot Crawler", r: "swarm" },
      { n: "Exsanguinate", r: "grunt" },
      { n: "Hemorrhage Priest", r: "caster" },
      { n: "Red Weeping Blade", r: "stalker" },
      { n: "Gore Colossus", r: "brute" },
      { n: "Scarlet Warden", r: "warden" },
    ],
  },
  {
    id: "graven_deep", name: "Graven Deep", lvl: 58, tier: 6,
    desc: "A necropolis that kept being dug downward long after there was anyone left to bury.",
    unlock: { type: "boss", value: "r4b2" },
    enemies: [
      { n: "Tomb Vermin", r: "swarm" },
      { n: "Interred Legionary", r: "grunt" },
      { n: "Epitaph-Speaker", r: "caster" },
      { n: "Graven Assassin", r: "stalker" },
      { n: "Mausoleum Golem", r: "brute" },
      { n: "Deep Warden", r: "warden" },
    ],
  },
  {
    id: "wailing_expanse", name: "The Wailing Expanse", lvl: 61, tier: 6,
    desc: "An open plain of grieving wind. The wailing is not the wind.",
    unlock: { type: "boss", value: "r4b3" },
    enemies: [
      { n: "Keening Wisp", r: "swarm" },
      { n: "Mourner Unending", r: "grunt" },
      { n: "Lamentation", r: "caster" },
      { n: "Grief-Maddened", r: "stalker" },
      { n: "Sorrow Behemoth", r: "brute" },
      { n: "Wailing Warden", r: "warden" },
    ],
  },
  {
    id: "rotting_throne", name: "The Rotting Throne", lvl: 64, tier: 6,
    desc: "A dead king still sits it, and the rot radiates outward in the shape of a court.",
    unlock: { type: "level", value: 64 },
    enemies: [
      { n: "Court Maggot", r: "swarm" },
      { n: "Putrid Courtier", r: "grunt" },
      { n: "Pestilence Vizier", r: "caster" },
      { n: "Throne Headsman", r: "stalker" },
      { n: "Bloated Regent", r: "brute" },
      { n: "Throne Warden", r: "warden" },
    ],
  },
  {
    id: "ashfall_necropolis", name: "Ashfall Necropolis", lvl: 67, tier: 6,
    desc: "A city of the dead under a sky that snows cinders. It has been burning, gently, forever.",
    unlock: { type: "boss", value: "r4b5" },
    enemies: [
      { n: "Ember Wight", r: "swarm" },
      { n: "Ashen Revenant", r: "grunt" },
      { n: "Cinder Necromancer", r: "caster" },
      { n: "Smoldering Reaver", r: "stalker" },
      { n: "Pyre Colossus", r: "brute" },
      { n: "Ashfall Warden", r: "warden" },
    ],
  },
  {
    id: "voidmaw", name: "Voidmaw", lvl: 70, tier: 6,
    desc: "A wound in the world that opens onto nothing, and the nothing is hungry.",
    unlock: { type: "boss", value: "r5b2" },
    enemies: [
      { n: "Null Swarmling", r: "swarm" },
      { n: "Unbeing", r: "grunt" },
      { n: "Voidcaller", r: "caster" },
      { n: "Maw-Touched Hunter", r: "stalker" },
      { n: "Devouring Vastness", r: "brute" },
      { n: "Void Warden", r: "warden" },
    ],
  },
  {
    id: "shrouded_abyss", name: "The Shrouded Abyss", lvl: 72, tier: 6,
    desc: "Deep enough that light was never a rumor here. The dark has weight and it leans on you.",
    unlock: { type: "boss", value: "r5b3" },
    enemies: [
      { n: "Shroud Leech", r: "swarm" },
      { n: "Abyssal Dweller", r: "grunt" },
      { n: "Fathom Oracle", r: "caster" },
      { n: "Blind Predator", r: "stalker" },
      { n: "Abyss Leviathan", r: "brute" },
      { n: "Shrouded Warden", r: "warden" },
    ],
  },
  {
    id: "the_last_dark", name: "The Last Dark", lvl: 75, tier: 6,
    desc: "The bottom of everything. There is nothing below this, and something is standing in it, waiting.",
    unlock: { type: "boss", value: "r5b5" },
    enemies: [
      { n: "Final Mote", r: "swarm" },
      { n: "The Extinguished", r: "grunt" },
      { n: "Herald of the Dark", r: "caster" },
      { n: "Last Executioner", r: "stalker" },
      { n: "Oblivion Hulk", r: "brute" },
      { n: "Dark Devourer", r: "caster" },
      { n: "Warden of the Last Dark", r: "warden" },
    ],
  },
];
